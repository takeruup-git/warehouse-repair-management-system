    ...
    if request.method == 'POST':
        try:
            ...
            if 'photo' in request.files and request.files['photo'].filename:
                ...
                upload_dir = os.path.join(current_app.config['UPLOAD_FOLDER'], 'facility', str(id))
                if not os.path.exists(upload_dir):
                    os.makedirs(upload_dir)
                photo_path = os.path.join(upload_dir, filename)
                photo.save(photo_path)
                photo_path = f"/static/uploads/facility/{id}/{filename}"
            ...
            if 'quotation' in request.files and request.files['quotation'].filename:
                ...
                quotation_path = f"/static/uploads/facility/{id}/{filename}"
            ...
            if 'approval_document' in request.files and request.files['approval_document'].filename:
                ...
                approval_document_path = f"/static/uploads/facility/{id}/{filename}"
            ...
            if 'completion_report' in request.files and request.files['completion_report'].filename:
                ...
                completion_report_path = f"/static/uploads/facility/{id}/{filename}"
